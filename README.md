...
<h3>Сферы в параллелепипедах (spheresinside.py)</h3>
...
<h3>Последняя цифра (lastdigit.py)</h3>
...
<h3>Минимальное число контейнеров (mincontainers.py)</h3>
...
<h3>Минимальное число опор (minprops.py)</h3>
Как известно, металлические предметы подвержены сжатию и расширению при изменении температуры. Это учитывают при проектировании длинных конструкций - железнодорожных путей, трубопроводов и т.д. Например, для длинных прямых участков трубопроводов предусматривают специальные компенсационные П-образные изгиьы, встраиваемые через определённое расстояние, которые помогают избежать повреждения трубопровода из-за температурных деформаций. Требуется составить программу, которая по заданному описанию трассировки проектируемого трубопровода определит минимально необходимое число компенсационных изгибов.

<h4>Формат входных данных</h4>
В первой строке через пробел записаны: максимально допустимое расстояние прямого участка проектируемого трубопровода (целое число K от 1 до 100), не требующее встраивания компенсационного изгиба, и количество участков на трассировке проектируемого трубопровода (целое число N от 1 до 100). Далее N строк с целыми числами - длинами участков трубопровода от 1 до 1000. Все участки трубопровода заданы последовательно и соединяются под прямым углом.

<h4>Формат результата</h4>
Целое число - минимально необходимое количество компенсационных изгибов для заданной трассировки.
...
<h3>Мороженое и холодильник (refrigerator.java)</h3>
...
<h3>Мороженое и холодильник 2 (refrigerator2.java)</h3>
...
<h3>Контрольная работа (controlwork.java)</h3>
...
<h3>Подготовка (preparations.java)</h3>
